...
class UserrequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create userrequest" do
    assert_difference('Userrequest.count') do
      post userrequests_url, params: { userrequest: { news: @userrequest.news, purpose: @userrequest.purpose } }
    end
  ...
  test "should update userrequest" do
    patch userrequest_url(@userrequest), params: { userrequest: { news: @userrequest.news, purpose: @userrequest.purpose } }
